tmask = ncread('meshmask.nc','tmask');
depth = ncread('meshmask.nc','nav_lev');
lon = ncread('meshmask.nc','nav_lon');
lat = ncread('meshmask.nc','nav_lat');
umask = ncread('meshmask.nc','umask');
vmask = ncread('meshmask.nc','vmask');
