...
# 17 - Po
rivermask[0:2,317-shift:319-shift,3:42] = True # 2 x-cells deleted from mouth for each y-row
rivermask[2,317-shift:319-shift,3:43] = True   # 1 x-cell deleted from mouth for each y-row
rivermask[0:3,297-shift:319-shift,24] = True   # 1 y-cell deleted from mouth 
# 18 - Reno + Lamone
